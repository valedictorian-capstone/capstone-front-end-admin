export const environment = {
  ...
  'api': {
    'basic-api': {
      ...
      'account-role': {
        'main': 'api/v1/AccountRole',
        'getById': 'api/v1/AccountRole/',
        'active': 'api/v1/AccountRole/Active',
        'deactive': 'api/v1/AccountRole/Deactive'
      },
      'account-department': {
        'main': 'api/v1/AccountDepartment',
        'getById': 'api/v1/AccountDepartment/',
        'active': 'api/v1/AccountDepartment/Active',
        'deactive': 'api/v1/AccountDepartment/Deactive'
      },
      'account-extra-data': {
      ...
      'account-extra-information-pattern': {
        'main': 'api/v1/AccountExtraInformationPattern',
        'getById': 'api/v1/AccountExtraInformationPattern/',
        'active': 'api/v1/AccountExtraInformationPattern/Active',
        'deactive': 'api/v1/AccountExtraInformationPattern/Deactive'
      },
      ...
      'customer-extra-information-pattern': {
        'main': 'api/v1/CustomerExtraInformationPattern',
        'getById': 'api/v1/CustomerExtraInformationPattern/',
        'active': 'api/v1/CustomerExtraInformationPattern/Active',
        'deactive': 'api/v1/CustomerExtraInformationPattern/Deactive'
      },
      ...
      'customer-group': {
        'main': 'api/v1/CustomerGroup',
        'getById': 'api/v1/CustomerGroup/',
        'active': 'api/v1/CustomerGroup/Active',
        'deactive': 'api/v1/CustomerGroup/Deactive'
      },
      'department': {
    ...
    'bpmn-api': {
      'account-work-flow-step-instance': {
        'main': 'api/v1/AccountWorkFlowStepInstance',
        'getById': 'api/v1/AccountWorkFlowStepInstance/',
        'active': 'api/v1/AccountWorkFlowStepInstance/Active',
        'deactive': 'api/v1/AccountWorkFlowStepInstance/Deactive'
      },
      'customer-work-flow-step-instance': {
        'main': 'api/v1/CustomerWorkFlowStepInstance',
        'getById': 'api/v1/CustomerWorkFlowStepInstance/',
        'active': 'api/v1/CustomerWorkFlowStepInstance/Active',
        'deactive': 'api/v1/CustomerWorkFlowStepInstance/Deactive'
      },
      'comment': {
        'main': 'api/v1/Comment',
      ...
      'form-control-pattern': {
        'main': 'api/v1/FormControlPattern',
        'getById': 'api/v1/FormControlPattern/',
        'active': 'api/v1/FormControlPattern/Active',
        'deactive': 'api/v1/FormControlPattern/Deactive'
      },
      'form-control': {
      ...
      'permission-work-flow-step': {
        'main': 'api/v1/PermissionWorkFlowStep',
        'getById': 'api/v1/PermissionWorkFlowStep/',
        'active': 'api/v1/PermissionWorkFlowStep/Active',
        'deactive': 'api/v1/PermissionWorkFlowStep/Deactive'
      },
      'role-permission': {
        'main': 'api/v1/RolePermission',
        'getById': 'api/v1/RolePermission/',
        'active': 'api/v1/RolePermission/Active',
        'deactive': 'api/v1/RolePermission/Deactive'
      },
      'form-group-work-flow-step': {
        'main': 'api/v1/FormGroupWorkFlowStep',
        'getById': 'api/v1/FormGroupWorkFlowStep/',
        'active': 'api/v1/FormGroupWorkFlowStep/Active',
        'deactive': 'api/v1/FormGroupWorkFlowStep/Deactive'
      },
      'work-flow': {
      ...
      'work-flow-condition': {
        'main': 'api/v1/WorkFlowCondition',
        'getById': 'api/v1/WorkFlowCondition/',
        'active': 'api/v1/WorkFlowCondition/Active',
        'deactive': 'api/v1/WorkFlowCondition/Deactive'
      },
      'work-flow-step': {
