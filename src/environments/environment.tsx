import { ApartmentOutlined, HomeOutlined, LayoutOutlined, LogoutOutlined, NotificationOutlined, PartitionOutlined, PhoneOutlined, ProfileOutlined, ProjectOutlined, PropertySafetyOutlined, SettingOutlined, SkinOutlined, SmileOutlined, SolutionOutlined, SyncOutlined, TagOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
            ...
            'components': {
              ...
              'product-control': {
                'vi': {
                  ...
                  'deactive': {
                    'tooltip': 'Nhấn để ngừng sử dụng thông tin thêm của sản phẩm',
                    'yes': 'Đồng ý',
                    'no': 'Hủy',
                    'confirm': 'Chắc chắn việc ngừng sử dụng thông tin thêm của sản phẩm này?',
                  },
                  'active': {
                    'tooltip': 'Nhấn để cho phép sử dụng thông tin thêm của sản phẩm',
                    'yes': 'Đồng ý',
                    'no': 'Hủy',
                    'confirm': 'Chắc chắn việc cho phép sử dụng thông tin thêm của sản phẩm này?',
                  },
                },
                'en': {
                  'drag': {
              ...
              'product-create': {
                'vi': {
                  ...
                  'fields': {
                    'code': {
                      'label': 'Mã sản phẩm',
                      'error-message': 'Mã sản phẩm không được trống',
                    },
                    'fullname': {
                      'label': 'Tên sản phẩm',
                      'error-message': 'Tên sản phẩm không được trống',
                    },
                    'email': {
                      'label': 'Thư điện tử',
                      'error-message': 'Thư điện tử sản phẩm không được trống',
                    },
                    'phone': {
                      'label': 'Số điện thoại',
                      'error-message': 'Số điện thoại sản phẩm không được trống',
                    },
                  },
                  'buttons': {
              ...
              'product-list': {
                'vi': {
                  ...
                  'search': {
                    ...
                    'fields': {
                      'code': 'Tìm kiếm theo mã sản phẩm',
                      'fullname': 'Tìm kiếm theo tên sản phẩm',
                      'email': 'Tìm kiếm theo thư điện tử sản phẩm',
                      'phone': 'Tìm kiếm theo số điện thoại sản phẩm',
                      'status': {
                        'label': 'Tìm kiếm theo trạng thái',
                        'active': 'Hoạt động',
                        'deactive': 'Đã dừng',
                  ...
                  'buttons': {
                    'create': {
                      'tooltip': 'Nhấn để thêm mới một sản phẩm',
                    },
                    'export-excel': {
                      'tooltip': 'Nhấn để tải tệp thông tin toàn bộ sản phẩm',
                    },
                    'import-excel': {
                      'tooltip': 'Nhấn để chèn thông tin các sản phẩm bằng tệp dữ liệu excel',
                    },
                    'deactive': {
                      'tooltip': 'Nhấn để ngừng sử dụng sản phẩm',
                      'yes': 'Đồng ý',
                      'no': 'Hủy',
                      'confirm': 'Chắc chắn việc ngừng sử dụng sản phẩm này?',
                    },
                    'active': {
                      'tooltip': 'Nhấn để cho phép sử dụng sản phẩm',
                      'yes': 'Đồng ý',
                      'no': 'Hủy',
                      'confirm': 'Chắc chắn việc cho phép sử dụng sản phẩm này?',
                    },
                    'setting': {
                      'edit': {
                        'tooltip': 'Nhấn để chỉnh sửa sản phẩm',
                      },
                      'preview': {
                        'tooltip': 'Nhấn để xem bản thực tế của sản phẩm',
                      },
                      'deactive': {
                        'tooltip': 'Nhấn để ngừng sử dụng sản phẩm',
                        'yes': 'Đồng ý',
                    ...
                    'create-with-search': 'Tạo mới sản phẩm theo dữ liệu tìm kiếm',
                  },
                  'col': {
                    'code': 'Mã sản phẩm',
                  ...
                  'empty-message': 'Không tìm thấy bất kỳ sản phẩm nào',
                },
                'en': {
                  'label': 'Danh sách sản phẩm',
                  'search': {
              ...
              'product-view': {
                'vi': {
                  'buttons': {
                    'back': {
                      'tooltip': 'Nhấn đế quay về trang danh sách sản phẩm',
                    },
                    'config': {
                      'tooltip': 'Nhấn để xem bản chỉnh của thông tin thêm của sản phẩm',
                    },
                    'preview': {
                      'tooltip': 'Nhấn để xem bản thực tế của thông tin thêm của sản phẩm',
                    },
                    'active': {
                      'tooltip': 'Nhấn để cho phép sử dụng thông tin thêm của sản phẩm',
                    },
