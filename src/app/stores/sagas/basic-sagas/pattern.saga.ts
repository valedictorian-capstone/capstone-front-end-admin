...
export const usePatternSaga = () => {
  ...
  function* useGetAll() {
    ...
    try {
      ...
      yield put(usePatternAction().getAllSuccess(data));
    } catch (error) {
      yield put(usePatternAction().getAllError(error));
    }
  ...
  function* useCreate(action: Pattern) {
    ...
    try {
      ...
      yield put(usePatternAction().createSuccess(data));
    } catch (error) {
      yield put(usePatternAction().createError(error));
    }
    yield put(useLoadingAction().hideLoader());
  }
  function* useUpdate(action: Pattern) {
    ...
    try {
      ...
      yield put(usePatternAction().updateSuccess(data));
    } catch (error) {
      yield put(usePatternAction().updateError(error));
    }
    yield put(useLoadingAction().hideLoader());
  }
  function* useRemove(action: Pattern) {
    ...
    try {
      ...
      yield put(usePatternAction().removeSuccess(data));
    } catch (error) {
      yield put(usePatternAction().removeError(error));
    }
    yield put(useLoadingAction().hideLoader());
  }
