...
export const useAccountAction = (): ActionCreatorsMapObject<Account> => {
  ...
  const getAll = (): Account => {
    return { type: ACCOUNT_TYPE.GETALL.FETCH, payload: { data: ACCOUNT_TYPE.GETALL.FETCH } };
  };
  ...
  const create = (data: AccountCM): Account => {
    return { type: ACCOUNT_TYPE.CREATE.FETCH, payload: { data } };
  };
  ...
  const update = (data: AccountUM): Account => {
    return { type: ACCOUNT_TYPE.UPDATE.FETCH, payload: { data } };
  };
  ...
  const remove = (data: string): Account => {
    return { type: ACCOUNT_TYPE.REMOVE.FETCH, payload: { data } };
  };
