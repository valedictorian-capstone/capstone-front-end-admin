...
export const useGroupAction = (): ActionCreatorsMapObject<Group> => {
  ...
  const getAll = (): Group => {
    return { type: GROUP_TYPE.GETALL.FETCH, payload: { data: GROUP_TYPE.GETALL.FETCH } };
  };
  ...
  const create = (data: GroupCM): Group => {
    return { type: GROUP_TYPE.CREATE.FETCH, payload: { data } };
  };
  ...
  const update = (data: GroupUM): Group => {
    return { type: GROUP_TYPE.UPDATE.FETCH, payload: { data } };
  };
  ...
  const remove = (data: string): Group => {
    return { type: GROUP_TYPE.REMOVE.FETCH, payload: { data } };
  };
