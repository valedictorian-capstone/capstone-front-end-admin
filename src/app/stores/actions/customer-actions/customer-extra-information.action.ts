...
export const useCustomerExtraInformationAction = (): ActionCreatorsMapObject<CustomerExtraInformation> => {
  ...
  const getAll = (): CustomerExtraInformation => {
    return { type: CUSTOMER_EXTRA_INFORMATION_TYPE.GETALL.FETCH, payload: { data: CUSTOMER_EXTRA_INFORMATION_TYPE.GETALL.FETCH } };
  };
  ...
  const create = (data: CustomerExtraInformationCM): CustomerExtraInformation => {
    return { type: CUSTOMER_EXTRA_INFORMATION_TYPE.CREATE.FETCH, payload: { data } };
  };
  ...
  const update = (data: CustomerExtraInformationUM): CustomerExtraInformation => {
    return { type: CUSTOMER_EXTRA_INFORMATION_TYPE.UPDATE.FETCH, payload: { data } };
  };
  ...
  const remove = (data: string): CustomerExtraInformation => {
    return { type: CUSTOMER_EXTRA_INFORMATION_TYPE.REMOVE.FETCH, payload: { data } };
  };
