...
import './department-support.component.css';

export interface IDepartmentSupportComponentProps extends IBaseProps {
  input: {
    action: 'create' | 'edit' | '',
    rows: DepartmentVM[],
  };
  output: {
    onCreate: () => void,
    onSearch: (rows: DepartmentVM[]) => void,
  };
}

export const DepartmentSupportComponent: React.FC<IDepartmentSupportComponentProps> = (props: IDepartmentSupportComponentProps) => {
  ...
  return (
    <div className="department-support">
      <Row>
        <Col xs={10} sm={10} md={12} lg={12} xl={16} xxl={16} className="department-support-left">
          <div>
        ...
        <Col xs={14} sm={14} md={12} lg={12} xl={8} xxl={8} className="department-support-right">
          <div>
            <Input onChange={(e) => {
