...
import './pattern-footer.component.css';

export interface IPatternFooterComponentProps extends IBaseProps {
  input: {
    rows: PatternVM[],
    selected: PatternVM | undefined,
    action: 'create' | 'edit' | '',
  };
  output: {
    onChange: (data: { rows: PatternVM[], itemPerPage: number }) => void,
  };
}

export const PatternFooterComponent: React.FC<IPatternFooterComponentProps> = (props: IPatternFooterComponentProps) => {
