...
import './account-preview.component.css';

export interface IAccountPreviewComponentProps extends IBaseProps {
  input: {
...
export const AccountPreviewComponent: React.FC<IAccountPreviewComponentProps> = (props: IAccountPreviewComponentProps) => {
  ...
  React.useEffect(() => {
    setAccountExtraInformations(props.input.extraInformations);
  }, [props.input.extraInformations]);
  return (
    <div className="ant-form ant-form-horizontal account-preview" style={{ width: '100%', height: '100%' }}>
