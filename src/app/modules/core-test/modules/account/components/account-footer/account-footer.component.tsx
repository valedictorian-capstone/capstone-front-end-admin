...
import './account-footer.component.css';

export interface IAccountFooterComponentProps extends IBaseProps {
  input: {
    rows: AccountVM[],
    selected: AccountVM | undefined,
    action: 'create' | 'edit' | 'setting' | '',
  };
  output: {
    onChange: (data: { rows: AccountVM[], itemPerPage: number }) => void,
  };
}

export const AccountFooterComponent: React.FC<IAccountFooterComponentProps> = (props: IAccountFooterComponentProps) => {
