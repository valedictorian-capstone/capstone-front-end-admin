...
import './product-footer.component.css';

export interface IProductFooterComponentProps extends IBaseProps {
  input: {
    rows: ProductVM[],
    selected: ProductVM | undefined,
    action: 'create' | 'edit' | 'setting' | '',
  };
  output: {
    onChange: (data: { rows: ProductVM[], itemPerPage: number }) => void,
  };
}

export const ProductFooterComponent: React.FC<IProductFooterComponentProps> = (props: IProductFooterComponentProps) => {
