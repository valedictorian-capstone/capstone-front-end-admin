...
import './customer-footer.component.css';

export interface ICustomerFooterComponentProps extends IBaseProps {
  input: {
    rows: CustomerVM[],
    selected: CustomerVM | undefined,
    action: 'create' | 'edit' | 'setting' | '',
  };
  output: {
    onChange: (data: { rows: CustomerVM[], itemPerPage: number }) => void,
  };
}

export const CustomerFooterComponent: React.FC<ICustomerFooterComponentProps> = (props: ICustomerFooterComponentProps) => {
