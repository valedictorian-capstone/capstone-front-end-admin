...
import { CustomerHelperComponent } from '..';
import './customer-support.component.css';

export interface ICustomerSupportComponentProps extends IBaseProps {
  input: {
  ...
  output: {
    onCreate: () => void,
    onSearch: (rows: CustomerVM[]) => void,
    onSetting: () => void,
  };
}

export const CustomerSupportComponent: React.FC<ICustomerSupportComponentProps> = (props: ICustomerSupportComponentProps) => {
  ...
  return (
    <div className="customer-support">
      <Row>
        <Col xs={10} sm={10} md={12} lg={12} xl={16} xxl={16} className="customer-support-left">
          <div>
            ...
            {props.input.action === 'setting' && <Popover id="rop-test" placement="topLeft" trigger="click" content={<CustomerHelperComponent input={{ horizontal: true }} output={{}} />}>
        ...
        <Col xs={14} sm={14} md={12} lg={12} xl={8} xxl={8} className="customer-support-right">
          <div>
