    ...
    <Row className="form-footer">
      ...
      <Col xs={24} sm={24} md={18} lg={18} xl={18} xxl={18}>
        <div className="middle">
          <Pagination disabled={props.input.selected !== undefined} count={getCount()} color="primary" variant="outlined" showFirstButton={true} showLastButton={true} onChange={(e, p) => setPage(p)} />
        </div>
      </Col>
      <Col xs={0} sm={0} md={3} lg={3} xl={3} xxl={3}>
        <div className="right">
          <Select disabled={props.input.selected !== undefined} style={{ width: '80%' }} value={count} onChange={(value) => {
            setCount(value);
            setPage(1);
          }}>
