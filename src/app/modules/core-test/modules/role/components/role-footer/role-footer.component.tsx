...
import './role-footer.component.css';

export interface IRoleFooterComponentProps extends IBaseProps {
  input: {
    rows: RoleVM[],
    selected: RoleVM | undefined,
    action: 'create' | 'edit' | '',
  };
  output: {
    onChange: (data: { rows: RoleVM[], itemPerPage: number }) => void,
  };
}

export const RoleFooterComponent: React.FC<IRoleFooterComponentProps> = (props: IRoleFooterComponentProps) => {
