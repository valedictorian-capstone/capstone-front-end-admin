...
import './account-option.component.css';
import { RestOutlined } from '@ant-design/icons';

export interface IAccountOptionComponentProps extends IBaseProps {
  input: {
...
export const AccountOptionComponent: React.FC<IAccountOptionComponentProps> = (props: IAccountOptionComponentProps) => {
  const region = useSelector<RootState, 'vi' | 'en' | 'jp'>((state) => state.language.language.region);
  const config = environment.i18n.data.core.modules.account.components['account-option'][region];
